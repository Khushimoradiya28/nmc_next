...
const DateCard = ({ date, title, align = "center" }) => {
  ...
  // Full date & time format (e.g., 30 Aug 2026, 03:45 PM)
  ...
  return (
    <div className="relative group inline-block">
      ...
      {/* Styled Hover Tooltip with Date & Time (Anti-clipping positioning) */}
      <div
...
const DateBox = ({ created_at, updated_at }) => {
  ...
  return (
    <div className="flex items-center gap-1.5">
      <DateCard date={createdDate} title="Created At" align="center" />
      <DateCard date={updatedDate} title="Updated At" align="right" />
    </div>
  );
};
