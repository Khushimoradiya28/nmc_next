...
const useRoleSubmit = (id) => {
  ...
  useEffect(() => {
    ...
    MaterialService.getBrandById(id)
      .then((res) => {
  ...
  if (id) {
    MaterialService.updateBrand(id, payload)
      .then((res) => {
    ...
    MaterialService.addData(payload)
      .then((res) => {
        notifySuccess(res.message);
        setIsUpdate(true);
        closeDrawer();
      ...
      <div className="w-full relative p-6 border-b border-gray-100 bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300">
        {id ? (
          <Title
            ...
            description="Update your Material and related information here"
          />
        ) : (
          <Title
            title="Add Material"
            description="Add a new Material and its details here"
          />
        )}
      </div>
      ...
      <div className="px-6 pt-8 flex-grow w-full h-full max-h-full pb-40 md:pb-32 lg:pb-32 xl:pb-32">
          ...
          <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
            ...
            <div className="col-span-8 sm:col-span-4">
              ...
              />
              <Error errorName={errors.material_name} />
            </div>
          </div>
