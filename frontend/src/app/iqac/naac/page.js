...
export default function NAACPage() {
    ...
    return ( <
        ...
        ol style = {
            {
                ...
                margin: 0,
                gap: '0.5rem',
                color: 'var(--color-secondary, #f4b000)',
                fontSize: '0.82rem',
                fontWeight: 600,
        ...
        <
        div className = {
            styles.aboutCardGlow
        } > < /div> <
        div className = {
            styles.aboutCardInner
        } >
        <
        div className = {
            styles.naacEmblem
        ...
        p className = {
            styles.aboutCardDesc
        } > Institutional commitment to academic excellence and continuous improvement < /p>

        <
        div className = {
            styles.aboutStatsRow
        } >
        <
        div className = {
            styles.aboutStat
        ...
        Every academic year, institutional performance is meticulously evaluated across seven critical criteria mandated by the NAAC framework
        ...
        <
        div className = {
            styles.aqarTableWrap
        } >
        <
        div className = {
            styles.aqarTableGlow
        } > < /div> <
        table className = {
            styles.aqarTable
        } >
        ...
        tbody > {
            aqarData.map((row, idx) => ( <
                ...
                td className = {
                    styles.aqarDoc
                } > Annual Quality Assurance Report(AQAR) < /td> <
                td >
                <
                span className = {
                    `${styles.aqarStatus} ${row.statusClass}`
                } > {
                    row.status
                } <
                /span> <
