...
export default function CollegeEventsPage() {
    ...
    return ( <
        ...
        <
        ActivityHero title = "College Events"
...

        {
            ...
            featured && activeCategory === 'All' && ( <
                ...
                /> <
                span className = {
                    styles.featuredImgTag
                } > {
                    featured.tag
                } < /span> <
                /div> <
                div className = {
                    styles.featuredTextCol
                } >
                <
                div className = {
                    styles.featuredMeta
                ...
                span className = {
                    styles.featuredCatBadge
                }
                style = {
                    {
                        background: featured.accentLight,
        ...
        h2 className = {
            styles.sectionTitle
        } > Campus < span > Calendar < /span></h2 >
        <
        p className = {
            styles.sectionSubtitle
        } > Every celebration that shapes the NMC spirit < /p> <
        /div>
        ...
        div className = {
            ...
            CATEGORIES.map(cat => ( <
                ...
                className = {
                    `${styles.filterBtn} ${activeCategory === cat ? styles.filterActive : ''}`
                }
                onClick = {
