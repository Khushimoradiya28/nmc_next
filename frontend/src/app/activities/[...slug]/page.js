...
export default async function ActivitiesSubPage({
    params
}) {
    const resolvedParams = await params;
    const slug = resolvedParams.slug || [];
                ...
                events.length > 0 ? ( <
                    div style = {
                        ...
                        events.map(event => ( <
                            ...
                            basePath = {
                                `/activities/${slug[0]}/${event.subCategoryId}`
                            }
                            />
                        ))
                    } <
                    ...
                    } > Events and updates will be available soon. < /p> <
                    /div>
                )
            } <
            /div> <
