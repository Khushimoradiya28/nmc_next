...
const IconBriefcase = () => ( <
    ...
    width = "20"
    height = "14"
    rx = "2" / > < path d = "M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2" / >
    <
    line x1 = "12"
    y1 = "12"
    x2 = "12"
    y2 = "12" / > < path d = "M12 12h.01" / >
    <
    /svg>
);
const IconMail = () => ( <
    ...
    width = "20"
    height = "16"
    rx = "2" / > < path d = "m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" / >
    <
    /svg>
);
const IconArrow = () => ( <
...
function AlumniAssociationPage() {
    ...
    return ( <
        ...
        <
        Image src = "https://images.unsplash.com/photo-1523580494863-6f3031224c94?w=800&q=85"
        ...
        A Network That < span className = {
            styles.highlight
        } > Never Stops < /span> Growing <
        /h2> <
        p className = {
            styles.leadText
        } >
        Our Alumni Association brings together thousands of graduates working across diverse sectors globally, fostering mentorship, career guidance, and lifelong sisterhood bonds. <
        /p> <
        /motion.div> <
        /motion.div>
        ...
        } >
        {
            programs.map((p, i) => ( <
                ...
                <
                div className = {
                    `${styles.cardIcon} ${styles[p.iconClass]}`
                } > {
                    p.icon
                } < /div> <
                h3 className = {
...
function OtherDetailsPage() {
    const milestones = [{
            year: '2024',
            title: 'Annual Alumni Meet — 15th Edition',
            desc: 'Over 400 alumni attended the landmark reunion. Featured keynotes from IAS officers, doctors, and fashion designers who are NMC graduates.'
        },
        {
            year: '2023',
            title: 'Scholarship Fund Launch',
            desc: '10 scholarships were awarded to meritorious students under the Alumni Scholarship Initiative, funded entirely by alumni contributions.'
        },
        {
            year: '2022',
            title: 'Industry Partnership Drive',
            desc: 'Alumni working in corporate sectors signed MoUs with the college to create placement channels for final-year students.'
        },
        {
            year: '2021',
            title: 'Digital Alumni Network',
            desc: 'Launch of the online alumni portal connecting 2,000+ graduates across 15 countries for mentorship and networking.'
        },
        {
            year: '2019',
            title: 'Centenary Alumni Celebration',
            desc: 'Grand centenary celebration with alumni from across India sharing their journeys and inspiring the next generation.'
        },
    ];
    ...
    return ( <
        ...
        span className = {
            styles.badge
        } > Legacy Milestones < /span> <
        h2 className = {
            styles.pageTitle
        } >
        Alumni < span className = {
            styles.highlight
        } > Achievements < /span> & Events <
        /h2> <
        p className = {
            styles.leadText
        } >
        Explore the milestones and achievements of our alumnae who have brought pride to NMC through their national and international accomplishments. <
        /p> <
        /motion.div>
        ...
        } > —Krina Gohil, Fashion Designer & nbsp;· & nbsp; Batch 2024 < /div> <
        /motion.div>

        {
            /* Image Grid */ } <
        motion.div className = {
            styles.alumniImageGrid
        }
        initial = "hidden"
        whileInView = "visible"
        viewport = {
...
function FeedbackLinkPage() {
    ...
    return ( <
        ...
        span className = {
            styles.badge
        } > Feedback Gateway < /span> <
        h2 className = {
            styles.pageTitle
        } >
        Your Voice < span className = {
            styles.highlightGold
        } > Shapes < /span> Our Future <
        /h2> <
        p className = {
            styles.leadText
        } >
        We constantly strive to improve our educational quality and student experience.Select your category below to submit feedback— your insights drive real change. <
        /p> <
        /motion.div> <
        motion.div className = {
            styles.feedbackImageWrap
        }
        variants = {
            scaleIn
        }
        ...
        <
        Image src = "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&q=85"
