        ...
        <div className={`${styles.digiCardsRow} digi-cards-row`}>
          ...
          <div className={`${styles.digiCard} digi-card`}>
            <div className={`${styles.digiCardInner} digi-card-inner`}>
              ...
              <p className={`${styles.digiCardText} digi-card-text`}>"NMC's approach to holistic women's education â€” combining academics with
                personality development and career skills â€” creates well-rounded graduates ready for the modern
                workforce."</p>
              <div className={`${styles.digiCardAuthor} digi-card-author`}>
                <div className={`${styles.digiAuthorImg} digi-author-img`}>
      ...
      <div className={`${styles.digiPanel} digi-panel`} id="studentsPanel">
        <div className={`${styles.studTestiGrid} stud-testi-grid`}>
          <div className={`${styles.studTestiCard} stud-testi-card`}>
            <div className={`${styles.studTestiStars} stud-testi-stars`}>â˜…â˜…â˜…â˜…â˜…</div>
          ...
          <div className={`${styles.studTestiCard} stud-testi-card`}>
            <div className={`${styles.studTestiStars} stud-testi-stars`}>â˜…â˜…â˜…â˜…â˜…</div>
            <p className={`${styles.studTestiQuote} stud-testi-quote`}>"Fashion Designing course at NMC was incredible â€” the studio, faculty, and
              practical exposure prepared me for the industry."</p>
            <div className={`${styles.studTestiAuthor} stud-testi-author`}>
