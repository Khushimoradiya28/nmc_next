...
export default function StatsSection() {
  ...
  useEffect(() => {
    ...
    const runCounterAnimation = () => {
      if (statsTriggered || !sectionRef.current) return;
      statsTriggered = true;
    ...
    if (rect.top < window.innerHeight && rect.bottom > 0) {
      setTimeout(runCounterAnimation, 300);
      return;
    }
    ...
    <section ref={sectionRef} className={`${styles.statsPremiumSection} stats-premium-section`}>
      <div className={`${styles.container} container`}>
        <div className={`${styles.statsPremiumGrid} stats-premium-grid`}>
          ...
          {/* STAT 1: 15+ Years */}
          <div className={`${styles.statPremiumCard} ${styles.statThemeRuby} stat-premium-card stat-theme-ruby spotlight-active`}>
          ...
          {/* STAT 2: 100% Free Bus */}
          <div className={`${styles.statPremiumCard} ${styles.statThemeGold} stat-premium-card stat-theme-gold spotlight-active`}>
            <div className={`${styles.statCardTop} stat-card-top`}>
          ...
          {/* STAT 3: 12+ Programs */}
          <div className={`${styles.statPremiumCard} ${styles.statThemeCrimson} stat-premium-card stat-theme-crimson spotlight-active`}>
            <div className={`${styles.statCardTop} stat-card-top`}>
          ...
          <div className={`${styles.statPremiumCard} ${styles.statThemeAmber} stat-premium-card stat-theme-amber spotlight-active`}>
            <div className={`${styles.statCardTop} stat-card-top`}>
